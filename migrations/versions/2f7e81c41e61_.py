...
Revision ID: 2f7e81c41e61
Revises: 81e0c0e44e34
Create Date: 2018-08-02 14:52:53.911112
...
revision = '2f7e81c41e61'
down_revision = '81e0c0e44e34'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    #op.drop_table('ama')
    op.add_column('users', sa.Column('review', sa.Text(), nullable=True))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('users', 'review')
    op.create_table('ama',
