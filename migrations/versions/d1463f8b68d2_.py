...
Revision ID: d1463f8b68d2
Revises: 02ffe876154e
Create Date: 2018-08-18 20:50:34.725143
...
revision = 'd1463f8b68d2'
down_revision = '02ffe876154e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('divesites', sa.Column('heart_id', sa.Integer(), nullable=True))
    op.create_foreign_key(None, 'divesites', 'divesites', ['heart_id'], ['id'])
...
def downgrade():
    ...
    op.drop_column('divesites', 'heart_id')
