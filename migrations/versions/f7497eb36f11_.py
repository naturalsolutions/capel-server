...
Revision ID: f7497eb36f11
Revises: f1ca14c6051f
Create Date: 2018-07-12 14:34:19.410599
...
revision = 'f7497eb36f11'
down_revision = 'f1ca14c6051f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('typepermits',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('start_at', sa.DateTime(), nullable=True),
    sa.Column('end_at', sa.DateTime(), nullable=True),
    sa.Column('template', sa.Unicode(length=255), nullable=True),
    ...
    op.add_column('divetypedives', sa.Column('dive_site_id', sa.Integer(), nullable=True))
    op.add_column('divetypedives', sa.Column('type_permit_id', sa.Integer(), nullable=True))
    op.create_foreign_key(None, 'divetypedives', 'divesites', ['dive_site_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(None, 'divetypedives', 'typepermits', ['type_permit_id'], ['id'], ondelete='CASCADE')
