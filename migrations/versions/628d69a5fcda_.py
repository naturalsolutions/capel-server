...
Revision ID: 628d69a5fcda
Revises: d119e9dfdd43
Create Date: 2018-09-20 15:34:05.240107
...
revision = '628d69a5fcda'
down_revision = 'd119e9dfdd43'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('users', sa.Column('common', sa.String(length=255), nullable=True))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('users', 'common')
