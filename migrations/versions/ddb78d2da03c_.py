...
Revision ID: ddb78d2da03c
Revises: 2f1152240728
Create Date: 2018-06-29 13:56:17.632092
...
revision = 'ddb78d2da03c'
down_revision = '2f1152240728'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('dives', sa.Column('comment', sa.Text(), nullable=True))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('dives', 'comment')
