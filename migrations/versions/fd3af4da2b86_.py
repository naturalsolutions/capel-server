...
Revision ID: fd3af4da2b86
Revises: f7497eb36f11
Create Date: 2018-07-16 12:18:02.436150
...
revision = 'fd3af4da2b86'
down_revision = 'f7497eb36f11'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('typepermithearts',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('type_permit_id', sa.Integer(), nullable=True),
    sa.Column('dive_site_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['dive_site_id'], ['divesites.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['type_permit_id'], ['typepermits.id'], ondelete='CASCADE'),
    ...
    op.drop_constraint('divetypedives_dive_site_id_fkey', 'divetypedives', type_='foreignkey')
    op.drop_constraint('divetypedives_type_permit_id_fkey', 'divetypedives', type_='foreignkey')
    op.drop_column('divetypedives', 'type_permit_id')
    op.drop_column('divetypedives', 'dive_site_id')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('divetypedives', sa.Column('dive_site_id', sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('divetypedives', sa.Column('type_permit_id', sa.INTEGER(), autoincrement=False, nullable=True))
    op.create_foreign_key('divetypedives_type_permit_id_fkey', 'divetypedives', 'typepermits', ['type_permit_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key('divetypedives_dive_site_id_fkey', 'divetypedives', 'divesites', ['dive_site_id'], ['id'], ondelete='CASCADE')
    ...
    op.drop_table('typepermithearts')
    # ### end Alembic commands ###
