...
Revision ID: d2196e1027cb
Revises: 60990d3cfe43
Create Date: 2018-06-08 11:56:39.721683
...
revision = 'd2196e1027cb'
down_revision = '60990d3cfe43'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('divesites', sa.Column('privacy', sa.String(), nullable=True))
    op.add_column('divesites', sa.Column('user_id', sa.Integer(), nullable=True))
    op.create_foreign_key(None, 'divesites', 'users', ['user_id'], ['id'])
    # ### end Alembic commands ###

def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'divesites', type_='foreignkey')
    op.drop_column('divesites', 'user_id')
    op.drop_column('divesites', 'privacy')
