...
Revision ID: 3da1716ca47e
Revises: 
Create Date: 2018-05-30 14:10:39.356819
...
def upgrade():
    ...
    op.add_column('users', sa.Column('zip', sa.String(length=255), nullable=True))
